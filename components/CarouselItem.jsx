...
export default function CarouselItem() {
    return (
        <Link href="schedule/1">
            <div href="#" className={`mt-20 flex flex-col rounded-lg border border-gray-200 shadow-md overflow-hidden w-full h-52 bg-red-400 hover:bg-red-300 my-auto hover:cursor-pointer`}>
